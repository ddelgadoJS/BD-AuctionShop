 ...
 * @author Kevin MM
 */
public class OracleSubastasGanadoras extends javax.swing.JFrame {

    /**
     * Creates new form PujasGanadoras
     */
    public OracleSubastasGanadoras() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OracleSubastasGanadoras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OracleSubastasGanadoras().setVisible(true);
            }
        });
    }
