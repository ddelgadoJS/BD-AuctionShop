 ...
 * @author Kevin MM
 */
public class OracleConsultarSubastasPorParticipante extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarSubastasPorParticipante
     */
    public OracleConsultarSubastasPorParticipante() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OracleConsultarSubastasPorParticipante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OracleConsultarSubastasPorParticipante().setVisible(true);
            }
        });
    }
