 ...
 * @author Kevin MM
 */
public class OracleConsultarAdminSubastasPorParticipante extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarAdminSubastasPorParticipante
     */
    public OracleConsultarAdminSubastasPorParticipante() {
        initComponents();
    ...
    private void ComboBoxModificarAliasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboBoxModificarAliasActionPerformed
        ...
        for (String subasta: rowsList) {
            ...
            model.addElement(parts[0] + ", Precio Inicial: $" + parts[1] + ", Precio Final: $" + parts[2] + ", Comentario comprador: " + parts[3] + ", Fecha final: " + parts[4]);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OracleConsultarAdminSubastasPorParticipante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OracleConsultarAdminSubastasPorParticipante().setVisible(true);
            }
        });
    }
