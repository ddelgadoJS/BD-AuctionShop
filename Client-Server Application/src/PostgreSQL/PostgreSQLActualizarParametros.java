 ...
 * @author Kevin MM
 */
public class PostgreSQLActualizarParametros extends javax.swing.JFrame {

    /**
     * Creates new form ActualizarParametros
     */
    public PostgreSQLActualizarParametros() {
        initComponents();
        SpinnerParametrosIncremento.setValue(Integer.valueOf(PostgreSQLPantallaInicial.incrementominimo));
        SpinnerParametrosPorcentaje.setValue(Float.valueOf(PostgreSQLPantallaInicial.porcentajemejora));
    }
    ...
    private void BotonParametrosAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonParametrosAceptarActionPerformed
        PostgreSQLPantallaInicial.incrementominimo = String.valueOf(SpinnerParametrosIncremento.getValue());
        PostgreSQLPantallaInicial.porcentajemejora = String.valueOf(SpinnerParametrosPorcentaje.getValue());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostgreSQLActualizarParametros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PostgreSQLActualizarParametros().setVisible(true);
            }
        });
    }
