 ...
 * @author Kevin MM
 */
public class ActualizarParametros extends javax.swing.JFrame {
    ...
    public ActualizarParametros() {
        initComponents();
        SpinnerParametrosIncremento.setValue(Integer.valueOf(PantallaInicial.incrementominimo));
        SpinnerParametrosPorcentaje.setValue(Float.valueOf(PantallaInicial.porcentajemejora));
    }
    ...
    private void BotonParametrosAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonParametrosAceptarActionPerformed
        PantallaInicial.incrementominimo = String.valueOf(SpinnerParametrosIncremento.getValue());
        PantallaInicial.porcentajemejora = String.valueOf(SpinnerParametrosPorcentaje.getValue());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarParametros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActualizarParametros().setVisible(true);
            }
        });
    }
