 ...
 * @author Kevin MM
 */
public class SubastasRealizadas extends javax.swing.JFrame {

    /**
     * Creates new form SubastasGanadoras
     */
    public SubastasRealizadas() {
        initComponents();
        ...
        String ALIASv = PantallaInicial.aliasUsuario;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubastasRealizadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SubastasRealizadas().setVisible(true);
            }
        });
    }
