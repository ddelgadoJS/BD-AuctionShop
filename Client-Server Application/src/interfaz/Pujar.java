...
public class Pujar extends javax.swing.JFrame {
    ...
    public Pujar(int idSubasta_, String precioActual) {
        ...
        if ((Integer.valueOf(precioActual)*Float.valueOf(PantallaInicial.porcentajemejora)) > Integer.valueOf(PantallaInicial.incrementominimo)) {
            monto = Integer.valueOf(precioActual)*Float.valueOf(PantallaInicial.porcentajemejora);
        }
        else{
            monto = Integer.valueOf(PantallaInicial.incrementominimo);
        }
