 ...
 * @author Kevin MM
 */
public class SubastasGanadoras extends javax.swing.JFrame {

    /**
     * Creates new form PujasGanadoras
     */
    public SubastasGanadoras() {
        initComponents();
        ...
        String query = "SP_GET_SUBASTAS_GANADORAS_USUARIO(ALIASv=>'" + ALIASv + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubastasGanadoras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SubastasGanadoras().setVisible(true);
            }
        });
    }
