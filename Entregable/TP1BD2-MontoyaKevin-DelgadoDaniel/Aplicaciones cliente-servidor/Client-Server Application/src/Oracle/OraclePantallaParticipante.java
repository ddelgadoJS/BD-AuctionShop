 ...
 * @author Kevin MM
 */
public class OraclePantallaParticipante extends javax.swing.JFrame {

    /**
     * Creates new form PantallaParticipante
     */
    public OraclePantallaParticipante() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OraclePantallaParticipante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OraclePantallaParticipante().setVisible(true);
            }
        });
    }
