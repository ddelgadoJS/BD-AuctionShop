 ...
 * @author Kevin MM
 */
public class PostgreSQLRegistrarUsuario extends javax.swing.JFrame {

    /**
     * Creates new form RegistrarUsuario
     */
    public PostgreSQLRegistrarUsuario() {
        initComponents();
    ...
    private void initComponents() {
        ...
        BotonRegistrarLogOut.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotonRegistrarLogOutActionPerformed(evt);
            }
        });
    ...
    private void BotonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonRegistrarActionPerformed
        ...
        String columnName = "ft_crear_usuario"; // Name of the returned column.
        
        String query = "SELECT FT_CREAR_USUARIO(ALIASv:='" 
                + ALIASv + "'::TEXT,NOMBREv:='" 
                + NOMBREv + "'::TEXT,APELLIDOSv:='" 
                + APELLIDOSv + "'::TEXT,DIRECCIONv:='" 
                + DIRECCIONv + "'::TEXT,CEDULAv:=" 
                + CEDULAv + "::INTEGER,CORREOv:='" 
                + CORREOv + "'::TEXT,CALIFICACIONv:=" 
                + CALIFICACIONv + "::SMALLINT,PASSWORDv:='" 
                + PASSWORDv + "'::TEXT,NUMEROv:='" 
                + NUMEROv + "'::TEXT,TIPOUSUARIOv:='" 
                + TIPOUSUARIOv + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostgreSQLRegistrarUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PostgreSQLRegistrarUsuario().setVisible(true);
            }
        });
    }
