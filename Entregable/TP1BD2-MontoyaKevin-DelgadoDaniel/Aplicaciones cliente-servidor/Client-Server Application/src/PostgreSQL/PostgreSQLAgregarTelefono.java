 ...
 * @author Kevin MM
 */
public class PostgreSQLAgregarTelefono extends javax.swing.JFrame {

    /**
     * Creates new form AgregarTelefono
     */
    public PostgreSQLAgregarTelefono() {
        initComponents();
    ...
    private void BotonAgregarAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonAgregarAgregarActionPerformed
        ...
        PostgreSQLConnection con_ = new PostgreSQLConnection();
        String columnName = "ft_agregar_tel"; // Name of the returned column.
        
        String query = "SELECT FT_AGREGAR_TEL(ALIASv:='" + ALIASv + 
                "'::TEXT,NUMEROv:='" + NUMEROv + 
                "'::TEXT,DESCRIPCIONv:='" + DESCRIPCIONv + 
                "'::TEXT)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostgreSQLAgregarTelefono.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PostgreSQLAgregarTelefono().setVisible(true);
            }
        });
    }
