...
CREATE OR REPLACE FUNCTION FT_HISTORIALPUJAS
  (IDSUBASTAv INTEGER)
...
BEGIN
  RETURN QUERY SELECT PUJA."ID", PUJA."ALIASCOMPRADOR", PUJA."IDSUBASTA", PUJA."MONTO", PUJA."FECHAHORA"
  FROM public."PUJA" PUJA
